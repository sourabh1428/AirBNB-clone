...
let arrayItem=obj.results[0];
const locationTop=document.getElementById("locationTop");
const reviewTop=document.getElementById("reviewTop");
const ratingTop=document.getElementById("ratingTop");
const hotelNameHead=document.getElementById("hotelNameHead");
const hosterName=document.getElementById("hosterName");
const lig=document.getElementById("li-g");
const amet1=document.getElementById("amet1");
const hotelBio=document.getElementById("hotelBio");
const wys=document.getElementById("whereYouSleep");
const ame1=document.getElementById("ame1");
const ame2=document.getElementById("ame2");


hotelNameHead.innerText=arrayItem.name;
ratingTop.innerText=arrayItem.rating;
reviewTop.innerText=arrayItem.reviewsCount;
locationTop.innerText=arrayItem.address;
hosterName.innerText="sourabh";



for(let i=1;i<=5;i++){
  const imgId=document.getElementById(`img${i}`);
  imgId.setAttribute("src",arrayItem.images[i]);
}
for(let i=-1;i<3;i++){
  const li=document.createElement("li");
  li.setAttribute("class","li-rooms");
  if(i==-1)li.innerText="2 guest";
  if(i==0)li.innerText=arrayItem.bedrooms+" bedroom";
  if(i==1)li.innerText=arrayItem.bedrooms+" bed";
  if(i==2)li.innerText=arrayItem.bathrooms+ " bath";
  lig.appendChild(li);
